        ...
        switch (method) {
            case "GET":
                ...
                if (query == null) {
                    ...
                    response = gson.toJson(taskManager.getAllTasks().stream()
                    ...
                    try {
                        ...
                        Task subtask = taskManager.getTaskById(id); // нормально ли в таску собранить сабтаск чтоб вызвать по айди?
                        if (subtask != null) {
            ...
            case "POST":
                ...
                try {
                    ...
                    if (taskManager.getTaskById(id) != null) {
                        ...
                        Task subtaskCreated = taskManager.saveNewTask(subtask);
            ...
            case "DELETE":
                ...
                if (query == null) {
                    taskManager.getAllTasks().stream()
                            .filter(task -> task.getClass() == EpicTask.class)
                            .flatMap(task -> ((EpicTask) task).getSubTasks().stream())
